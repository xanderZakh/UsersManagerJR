        ...
        <div class="panel panel-primary">
            ...
            <form:form action="${addAction}" commandName="user">
                <div class="form-group">
                    ...
                    <form:input class="form-control" placeholder="ID" readonly="true" path="id" value="${user.id}"/>
                </div>
                <div class="form-group">
                ...
                <input type="submit" class="btn btn-default" value="<spring:message text="Edit User"/>"/>
            </form:form>
